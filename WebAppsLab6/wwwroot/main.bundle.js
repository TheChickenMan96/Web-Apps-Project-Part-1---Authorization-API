...
var NavComponent = /** @class */ (function () {
    ...
    NavComponent.prototype.login = function () {
        console.log(this.authService.login(this.model).subscribe());
    };
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.showSuccess = function () {
        if (this.err == null && this.data == null) {
            return false;
        }
    ...
    RegisterComponent.prototype.showFailure = function () {
        if (this.err == null && this.data == null) {
            return false;
        }
        else if (this.err != null && this.data == null) {
            return true;
        }
    };
    RegisterComponent.prototype.register = function () {
        var _this = this;
        this.authService.register(this.model).subscribe(function (data) { return _this.data = data; }, function (error) { return _this.err = error; });
    };
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.login = function (model) {
        ...
        var credentials = { 'userName': model.username, 'password': model.password };
        return this.http.post(this.baseUrl + 'login', credentials, { headers: contentHeader });
    };
    AuthService.prototype.register = function (model) {
        var contentHeader = new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["c" /* HttpHeaders */]({ 'Content-type': 'application/json' });
        var newUser = { 'userName': model.username, 'password': model.password };
        return this.http.post(this.baseUrl + 'register', newUser, { headers: contentHeader });
    };
